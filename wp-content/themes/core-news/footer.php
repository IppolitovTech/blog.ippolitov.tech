<?php 
    $copyright = get_theme_mod('core_blog_copyright',esc_html__('Proudly Powered By WordPress', 'core-news'));
...
<button onclick="topFunction()" id="myBtn" title="<?php echo esc_attr__("Go to top", 'core-news') ?>">
